...
This is a table I created showing the top 10 zip codes withe the largest drop in price from January 2020 to January 2021. All 10 of these zip codes are in Manhattan, which is typically the borough with the highest rental prices. When there are even moderate percentage drops in the rental prices, the absolute decrease value is still large. The highest drop is $913 in zip code 1007, likely influenced by the COVID-19 pandemic.
